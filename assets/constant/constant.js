...
`,
  ...
  description: `Developed a global library application enabling librarians to register colleges and generate unique library
codes, which users utilize alongside their username and password for authentication. Users can then access features such
as checking issued books and viewing late fee amounts. <br>
• Spearheaded the development of a global library application, Koha-OPAC, catering to educational institutions
worldwide.<br>
• Implemented a user-friendly registration system for librarians to onboard colleges seamlessly, enhancing accessibility
and user adoption.<br>
• Engineered a robust authentication mechanism allowing users to log in using a unique library code generated by the
system, ensuring secure access to library services.<br>
• Integrated comprehensive functionalities enable users to check issued books, track late fee amounts, and manage their
library transactions efficiently.`,
  // link: {
...
},
{
  ...
  description: `Gift Card Management System is a comprehensive platform that includes both an admin dashboard and a
customer-facing website. It offers users the convenience of purchasing gift cards, earning rewards with each transaction,
and managing their accounts seamlessly. <br>
• Users can buy gift cards online and earn rewards with each transaction, redeemable for discounts or special offers. Mark
gift cards as favorites for easy access and quick purchases. <br>
• Developed an Admin portal to track balances, transaction history, and rewards. Access exclusive offers and discounts available for products, enhancing the value of gift card
purchases. <br>
• Receive automated email updates for purchase confirmations.`,
  link: {
...
},
{
  ...
  description: `Awaitero's cutting-edge digital menu, ordering, and billing software. Say goodbye to traditional menus and
embrace our QR-based system for maximum customer safety. Enable seamless dine-in ordering by simply scanning a QR
code at the restaurant. <br>
• Efficiently handle incoming orders, manage table assignments, and generate/print bills for completed orders.<br>
• Enable super admins to add and update restaurant details, and manage contracts for smooth operations.<br>
• Allow customers to instantly view the total bill amount before confirming orders, enhancing transparency and convenience.<br>
• Provide customers with secure login, intuitive menu browsing, easy cart management, and seamless order placement.`,
  link: {
